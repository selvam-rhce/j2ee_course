...
public class Qus1_array {

	public static void main(String[] args) {
		
/*
 * Qus: Write a program to accept 5 employee IDs and the corresponding names 
 * and their salaries from the user and store them in three arrays.
 * Pass these arrays to a function display() as arguments. 
 * This display() will display the content of the arrays in the table format.
 * 
 */
